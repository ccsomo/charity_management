...
describe DonationsController do
  ...
  def valid_attributes
    ...
    { type: "CashDonation", date: "2013-04-01", amount: 25.50, person_id: person.id }
  end
  ...
  describe "GET index" do
    it "assigns all donations as @donations" do
      donation = FactoryGirl.create(:donation, valid_attributes)
      p donation.inspect
  ...
  describe "GET show" do
    it "assigns the requested donation as @donation" do
      donation = FactoryGirl.create(:cash_donation, valid_attributes)
      get :show, {:id => donation.to_param, :type => donation.type}, valid_session
