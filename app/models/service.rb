...
class Service < ActiveRecord::Base
  attr_accessible :date, :description, :hours, :notes, :returned_survey, :sent_survey, :trained, :willing_to_return, :place_id, :person_ids, :group_ids, :in_kind_donation_attributes
  ...
  accepts_nested_attributes_for :in_kind_donation, allow_destroy: true
